...
impl Subscriber
{
    ...
    pub fn new(&mut self, MasterIP: String, MasterPort: u16, Name: String, IP: String, Port: u16) -> Subscriber
    {
        return Subscriber{self.channelInfo.insert("Master", (&MasterIP, &MasterPort)), &IP, &Port}
    }
    ...
    pub fn connect(&mut self, Name: String)
    {
        ...
        let messageSent = Message{&"S", &self.ip, &self.port, &""};         // create message object
